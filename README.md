...
本版为 **1.5.2**。便携包、分卷与校验码以 [v1.5.2 Release](https://github.com/mason369/AI-RVC/releases/tag/v1.5.2) 的实际附件为准；Docker 使用固定的 `1.5.2-cpu` / `1.5.2-cuda` 镜像标签。部署、持久化和登录用法见 [Docker 使用指南](docs/Docker使用指南.md)，发行核对见[发布与验收](docs/发布准备.md)。
